...
export class VerticalMenuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.verticalMenu.push(new MenuElementModel("My templates", Constrains.myJournalsPage));
    this.verticalMenu.push(new MenuElementModel("Create template", Constrains.createJournalPage));
  }
