    ...
    inherits: f.AmCoordinateChart, construct: function (a) {
      ...
      if (!a.zbSet) {
        ...
        var c = a.color, d = a.fontSize, g = a.zoomOutButtonImageSize,
          ...
          l = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, m = a.zoomOutButtonFontSize, p = a.zoomOutButtonPadding;
        isNaN(m) || (d = m);
      ...
      var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, g = this.plotAreaWidth - 1,
        h = this.plotAreaHeight - 1, e = this.plotAreaFillColors, l = this.plotAreaFillAlphas,
      ...
      c - b < d && (c = b + (c - b) / 2, b = c - d / 2, c += d / 2, 1 < c && (b -= c - 1, c = 1));
      b = f.roundTo(b, g);
      c = f.roundTo(c, g);
      d = !1;
      if (a) {
      ...
      if (this.skipZoomed) this.skipZoomed = !1; else {
        var b = this.startX0, c = this.endX0, d = this.endY0, g = this.startY0, h = a.startX, e = a.endX, f = a.startY,
          k = a.endY;
    ...
    inherits: f.AmRectangularChart, construct: function (a) {
      ...
      if (b) {
        ...
        var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "),
          g = b.valueAxis, h = this.chartData, e = b.numberFormatter;
        e || (e = this.nf);
        for (var l = 0; l < c.length; l++) {
          for (var k = c[l], m = 0, p = 0, n = 0, u = 0, v, x, E, t, r, B, q, w, y, C,
                 F = this.start; F <= this.end; F++) {
            var D = h[F];
            if (D) {
  ...
  f.Cuboid = f.Class({
    construct: function (a, b, c, d, f, h, e, l, k, m, p, n, u, v, x, E, t) {
      ...
      var b = this.container, c = b.chart, d = this.w, g = this.h, h = this.dx, e = this.dy, l = this.colors,
        ...
        v = this.cornerRadius, x = this.dashLength, E = this.pattern, t = this.topRadius, r = this.bcn, B = l, q = l;
